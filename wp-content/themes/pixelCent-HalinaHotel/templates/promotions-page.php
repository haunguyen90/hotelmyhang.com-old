...
<div class="container main-page"><div class="row">
  ...
  <div class="row list-room">
    ...
    <?php
	  ...
	  ?>
    <div class="col-md-4 col-sm-6"> <a href="<?=get_permalink($child_page->ID); ?>" title="<?=$child_page->post_title; ?>">
      <div class="deal-box">
        <div class="border-img"><?php echo get_the_post_thumbnail( $child_page->ID, 'medium' ); ?>
          <figcaption>
          <h2>
            <?=$child_page->post_title; ?>
          </h2>
          <span class="view-more"><?php if(get_locale() == 'en_US') {
	echo 'Read More';
}else{
	echo 'Xem thêm';
} ?><span>
