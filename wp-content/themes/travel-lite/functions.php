...
// Content Type Showing
	...
	function travel_creditline() { echo '<span class="credit">| Travel Theme by: <a href="'. esc_url('http://d5creation.com/theme/travel').'" target="_blank"><img  src="' . get_template_directory_uri() . '/images/d5logofooter.png" /> D5 Creation</a> | Powered by: <a href="http://wordpress.org" target="_blank">WordPress</a></span>'; }
